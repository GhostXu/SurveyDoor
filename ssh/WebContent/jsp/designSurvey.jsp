				...
				<tr>
					...
					<!-- struts2可以直接调用方法 -->
						<s:if test="logoPhotoExists()">
							<img src='<s:url value="%{logoPhotoPath}"/>' height="30px" width="50px">
						</s:if>
						<!-- 调查标题 -->
											...
											<td>
												<table>
													<tr>
														...
														<td class="tdPHeaderR">
															<s:a action="pageAction_toEditPage?sid=%{sId}&pid=%{pId}" namespace="/">编辑页标题</s:a>&nbsp;
																		...
																		<table>
																			...
																			<tr>
																				...
																				<td class="tdQHeaderR">
																					...
																					<s:a action="questionAction_deleteQuestion?sid=%{sId}&pid=%{pId}&qid=%{qId}" namespace="/">删除问题</s:a>&nbsp;
																				</td>
																			</tr>
																			<tr>
